 ...
 *
 * By default this display the default sidebar or 'sidebar-1'. If your theme specifies the 'id' or
 * 'name' parameter for ists registered sidebars you can pass an id or name as the $index parameter.
 * Otherwise, you can pass in a numerical index to display the sidebar at that index.
 *
 * @since 2.2.0
 *
 * @param int|string $index Optional, default is 1. Index, name or ID or dynamic sidebar.
