<p><code><a href="https://developer.wordpress.org/reference/functions/wp_install/">wp_install()</a></code></p>
...
>>>> [`WP_Object_Cache::_exists()`](https://developer.wordpress.org/reference/classes/wp_object_cache/_exists/)
>> 
>> [`do_action()`](https://developer.wordpress.org/reference/functions/do_action/) - [`delete_option_{$option}`](https://developer.wordpress.org/reference/hooks/delete_option_option/)
>> 
>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
>> 
>> [`do_action()`](https://developer.wordpress.org/reference/functions/do_action/) - [`delete_option`](https://developer.wordpress.org/reference/hooks/delete_option/)
>> 
>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
> 
...
> [`populate_roles_160()`](https://developer.wordpress.org/reference/functions/populate_roles_160/)
> 
>> [`_x()`](https://developer.wordpress.org/reference/functions/_x/)
>> 
>>> [`translate_with_gettext_context()`](https://developer.wordpress.org/reference/functions/translate_with_gettext_context/)
...
>>>> 
>>>>> [`WP_Roles::_init()`](https://developer.wordpress.org/reference/classes/wp_roles/_init/)
>>>>> 
...
>>> 
>>> [`WP_Roles::add_role()`](https://developer.wordpress.org/reference/classes/wp_roles/add_role/)
>>> 
...
>>>>>>> [`is_serialized()`](https://developer.wordpress.org/reference/functions/is_serialized/)
>>>>> 
>>>>> [`apply_filters()`](https://developer.wordpress.org/reference/functions/apply_filters/) - [`pre_update_option_{$option}`](https://developer.wordpress.org/reference/hooks/pre_update_option_option/)
>>>>> 
>>>>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
>>>>> 
>>>>> [`apply_filters()`](https://developer.wordpress.org/reference/functions/apply_filters/) - [`pre_update_option_{$value}`](https://developer.wordpress.org/reference/hooks/pre_update_option_value/)
>>>>> 
>>>>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
>>>>> 
>>>>> `add_option()`
...
>>>>> `maybe_serialize()`
>>>>> 
>>>>> [`do_action()`](https://developer.wordpress.org/reference/functions/do_action/) - [`update_option`](https://developer.wordpress.org/reference/hooks/update_option/)
>>>>> 
>>>>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
>>>>> 
>>>>> `wpdb::update()`
...
>>>>>>>> [`WP_Object_Cache::set()`](https://developer.wordpress.org/reference/classes/wp_object_cache/set/)
>>>>> 
>>>>> [`do_action()`](https://developer.wordpress.org/reference/functions/do_action/) - [`update_option_{$option}`](https://developer.wordpress.org/reference/hooks/update_option_option/)
>>>>> 
>>>>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
>>>>> 
>>>>> [`do_action()`](https://developer.wordpress.org/reference/functions/do_action/) - [`updated_option`](https://developer.wordpress.org/reference/hooks/updated_option/)
>>>>> 
>>>>>> [`_wp_call_all_hook()`](https://developer.wordpress.org/reference/functions/_wp_call_all_hook/)
>>>> 
>>>> [`new WP_Role()`](https://developer.wordpress.org/reference/classes/wp_role/)
